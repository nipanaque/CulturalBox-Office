...
<section class="page-section bg-light" id="portfolio">
            ...
            <div class="row justify-content-evenly">
                ...
                <div class="col-5">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="assets/img/Directores/20.jpg" style="width:180px; height:200px" class="img-fluid rounded-start" alt="...">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <input class="form-check-input position-absolute end-0 top-0 border m-2"   type="checkbox"  value="" aria-label="..." style="width:30px; height:30px ">
    ...
    <div class="text-center">
        ...
        <a href="AgregarActor.html"><button type="button" class="btn btn-secondary">Agregar</button></a>
    </div>
