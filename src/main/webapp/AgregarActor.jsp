...
<section class="page-section bg-light" id="portfolio">
    ...
    <form class="row g-3 needs-validation" novalidate action="<%=request.getContextPath()%>/Actores?a=agregar" method="POST" enctype="multipart/form-data">
        <div class="row justify-content-center">
            ...
            <div class="text-center">
                ...
                <a href="Actores" class="btn btn-secondary">Regresar</a>
