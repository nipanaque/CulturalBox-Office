            ...
            <div   class="container">
                ...
                <div class="row align-items-stretch mb-5">
                    ...
                    for (Calificacion calificacion1 : listaCalificacion) {
                        ...
                        <% if(r==2){%>
                            <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                        <%}else if(r==3){%>
                            <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                    <%}else if(r==4){%>
                                        <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==5){%>
                                        <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==6){%>
                                        <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==7){%>
                                                <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&a7=<%=listaCalificacion.get(6).getPuntajeActor()%>%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==8){%>
                                                <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&a7=<%=listaCalificacion.get(6).getPuntajeActor()%>&a8=<%=listaCalificacion.get(7).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==9){%>
                                                <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&a7=<%=listaCalificacion.get(6).getPuntajeActor()%>&a8=<%=listaCalificacion.get(7).getPuntajeActor()%>&a9=<%=listaCalificacion.get(8).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==10){%>
                                            ...
                                            <%}else if(r==11){%>
                                                <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&a7=<%=listaCalificacion.get(6).getPuntajeActor()%>&a8=<%=listaCalificacion.get(7).getPuntajeActor()%>&a9=<%=listaCalificacion.get(8).getPuntajeActor()%>&a10=<%=listaCalificacion.get(9).getPuntajeActor()%>&a11=<%=listaCalificacion.get(9).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==12){%>
                                                <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&a7=<%=listaCalificacion.get(6).getPuntajeActor()%>&a8=<%=listaCalificacion.get(7).getPuntajeActor()%>&a9=<%=listaCalificacion.get(8).getPuntajeActor()%>&a10=<%=listaCalificacion.get(9).getPuntajeActor()%>&a11=<%=listaCalificacion.get(9).getPuntajeActor()%>&a12=<%=listaCalificacion.get(9).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==13){%>
                                                <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&a7=<%=listaCalificacion.get(6).getPuntajeActor()%>&a8=<%=listaCalificacion.get(7).getPuntajeActor()%>&a9=<%=listaCalificacion.get(8).getPuntajeActor()%>&a10=<%=listaCalificacion.get(9).getPuntajeActor()%>&a11=<%=listaCalificacion.get(9).getPuntajeActor()%>&a12=<%=listaCalificacion.get(9).getPuntajeActor()%>&a13=<%=listaCalificacion.get(9).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                            <%}else if(r==14){%>
                                                <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&a7=<%=listaCalificacion.get(6).getPuntajeActor()%>&a8=<%=listaCalificacion.get(7).getPuntajeActor()%>&a9=<%=listaCalificacion.get(8).getPuntajeActor()%>&a10=<%=listaCalificacion.get(9).getPuntajeActor()%>&a11=<%=listaCalificacion.get(9).getPuntajeActor()%>&a12=<%=listaCalificacion.get(9).getPuntajeActor()%>&a13=<%=listaCalificacion.get(9).getPuntajeActor()%>&a14=<%=listaCalificacion.get(9).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                                    <%}else if(r==15){%>
                                                <form id="myform" method="POST" action="<%=request.getContextPath()%>/CalificacionServlet?a=guardar&f=<%=listaCalificacion.get(0).getPuntajeFuncion()%>&d=<%=listaCalificacion.get(0).getPuntajeDirector()%>&a1=<%=listaCalificacion.get(0).getPuntajeActor()%>&a2=<%=listaCalificacion.get(1).getPuntajeActor()%>&a3=<%=listaCalificacion.get(2).getPuntajeActor()%>&a4=<%=listaCalificacion.get(3).getPuntajeActor()%>&a5=<%=listaCalificacion.get(4).getPuntajeActor()%>&a6=<%=listaCalificacion.get(5).getPuntajeActor()%>&a7=<%=listaCalificacion.get(6).getPuntajeActor()%>&a8=<%=listaCalificacion.get(7).getPuntajeActor()%>&a9=<%=listaCalificacion.get(8).getPuntajeActor()%>&a10=<%=listaCalificacion.get(9).getPuntajeActor()%>&a11=<%=listaCalificacion.get(9).getPuntajeActor()%>&a12=<%=listaCalificacion.get(9).getPuntajeActor()%>&a13=<%=listaCalificacion.get(9).getPuntajeActor()%>&a14=<%=listaCalificacion.get(9).getPuntajeActor()%>&a15=<%=listaCalificacion.get(9).getPuntajeActor()%>&idcompra=<%=idcompra%>">
                                                        <%}%>
